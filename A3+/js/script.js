...
function palindromeCheck(str) {
	...
	str = str.toLowerCase().replace(/[^a-zа-дж-щыэ-я]/g, '');  // приводим строку к нижнему регистру и с помощью регулярного выражения удаляем все символы кроме букв, а также буквы Ь, Ъ, Е, Ё.
