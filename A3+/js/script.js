...
function palindromeCheck(str) {
	...
	str = str.toLowerCase().replace(/[^a-zа-яё]/g, '').replace(/[\е\ё\ъ\ь]/g, 'Ы');  // приводим строку к нижнему регистру и с помощью регулярного выражения удаляем все символы кроме букв, все символы ё, ъ, ь заменяем на ЛЮБОЙ символ, отличный от символов букв в нижнем регистре (я выбрал символ "Ы" верхнем регистре).
